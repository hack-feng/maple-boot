...
// user
declare type CommonType<T = any> = {
	[key: string]: T;
};

interface CommonTableType extends TableType {
	records: CommonType[];
}

declare interface CommonTableState {
	tableData: CommonTableType;
}

declare interface CommonParamState<T = any> {
	[key: string]: T;
}
