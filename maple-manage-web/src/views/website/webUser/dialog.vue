<template>
  <div class="website-webUser-dialog-container">
    <el-dialog :title="state.dialog.title" v-model="state.dialog.isShowDialog" width="60%">
          <el-form ref="webUserDialogFormRef" :model="state.ruleForm" :rules="state.rules" size="default" label-width="90px">
            <el-row :gutter="35">

              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="用户账号" prop="userNo">
                  <el-input v-model="state.ruleForm.userNo" placeholder="请输入用户账号" clearable></el-input>
                </el-form-item>
              </el-col>

              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="微信小程序唯一标识符" prop="openid">
                  <el-input v-model="state.ruleForm.openid" placeholder="请输入微信小程序唯一标识符" clearable></el-input>
                </el-form-item>
              </el-col>

              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="微信开放平台唯一标识符" prop="unionid">
                  <el-input v-model="state.ruleForm.unionid" placeholder="请输入微信开放平台唯一标识符" clearable></el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
                <el-form-item label="用户描述" prop="userDesc">
                  <el-input type="textarea" :rows="3"  v-model="state.ruleForm.userDesc" placeholder="请输入用户描述" clearable></el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
                <el-form-item label="头像链接" prop="headPortraitLink">
                  <el-input type="textarea" :rows="3"  v-model="state.ruleForm.headPortraitLink" placeholder="请输入头像链接" clearable></el-input>
                </el-form-item>
              </el-col>

              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="版本号" prop="version">
                  <el-input v-model="state.ruleForm.version" placeholder="请输入版本号" clearable></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
<script setup lang="ts" name="dictDialog">
  ...
  const state = reactive({
    ...
    rules: {
      userNo: { required: true, message: '请输入用户账号', trigger: 'blur' },
    },
  });
