            ...
            <el-row :gutter="35">
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
                <el-form-item label="父节点" prop="ancestorsArray">
                  <el-cascader
                      :options="props.webArticleOptions"
              ...
              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="图标" prop="icon">
                  <el-input v-model="state.ruleForm.icon" placeholder="请输入图标" clearable></el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="目标地址" prop="target">
                  <el-input v-model="state.ruleForm.target" placeholder="请输入目标地址" clearable></el-input>
                </el-form-item>
              </el-col>

              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
                <el-form-item label="跳转地址" prop="url">
                  <el-input type="textarea" :rows="3"  v-model="state.ruleForm.url" placeholder="请输入跳转地址" clearable></el-input>
                </el-form-item>
              </el-col>
