...
public class WebConfigController {
    ...
    @ApiOperation(value = "分页查询网站配置列表", notes="网站配置-分页查询列表", nickname = "www.xiaoxiaofeng.com")
    ...
    @ApiOperation(value = "根据id查询网站配置信息", notes="网站配置-根据id查询数据信息", nickname = "www.xiaoxiaofeng.com")
    @GetMapping(value = "/{id}")
    public WebConfigModel getWebConfigById(@PathVariable("id") Long id) {
        return webConfigService.getWebConfigById(id);
    }

    @ApiOperation(value = "新增网站配置数据", notes="网站配置-新增数据", nickname = "www.xiaoxiaofeng.com")
    ...
    @ApiOperation(value = "修改网站配置数据", notes="网站配置-修改数据", nickname = "www.xiaoxiaofeng.com")
    ...
    @ApiOperation(value = "删除网站配置", notes="网站配置-根据id删除数据信息", nickname = "www.xiaoxiaofeng.com")
    @DeleteMapping("/{id}")
